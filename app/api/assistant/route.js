  ...
  return experimental_AssistantResponse(
    ...
    async ({ threadId, sendMessage }) => {
      ...
      const run = await openai.beta.threads.runs.create(threadId, {
        ...
        instructions:
          'Remove all citation markers from your response. Do not use 【】 brackets or any reference numbers. Answer in plain text only without mentioning sources, documents, or pages. Treat this as a conversation where you provide information directly without academic citations.',
      });
